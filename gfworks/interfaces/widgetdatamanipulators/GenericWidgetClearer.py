...
class GenericValueSetter(object):
    ...
    def clear_text_entry(self, text_entry) -> None:
        """
    ...
    def reset_percentage_progress_bar(self, percentage_progress_bar) -> None:
        """
    ...
    def clear_primitive_combo_box(self, primitive_combo_box) -> None:
        """
    ...
    def clear_primitive_multi_list_box(self, primitive_multi_list_box) -> None:
        """
    ...
    def reset_check_box(self, check_box) -> None:
        """
    ...
    def reset_radio_button(self, radio_button) -> None:
        """
